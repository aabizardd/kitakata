...
<div id="app">
    ...
    <div id="main">
        ...
        <form action="<?= base_url('admin/update_book') ?>" method="POST" enctype="multipart/form-data">

            <div class="page-heading">
                <h3>Edit Buku
                    <button style="float: right;" class="btn btn-info" type="submit">
                        <i class="fas fa-save"></i> Update Data Buku
                    </button>
                </h3>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" class="form-control" name="book_cover_old"
                                    value="<?= $book_detail['book_cover'] ?>" />

                                <input type="hidden" class="form-control" name="book_id"
                                    value="<?= $book_detail['book_id'] ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="helperText" class="form-control" placeholder="Judul Buku"
                                        name="book_name" rows="4" required><?= $book_detail['book_name'] ?></textarea>
                                    <p>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="helperText" class="form-select" name="book_category" required>
                                        ...
                                        <option value="<?= $c->category_id ?>"
                                            <?= $book_detail['book_category'] ==  $c->category_id ? 'selected' : ''; ?>>
                                            <?= $c->category_name ?>
                                        </option>
                                        <?php endforeach ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="helperText" class="form-control" placeholder="Diskon Harga"
                                        name="book_discount" min="0" value="<?= $book_detail['book_discount'] ?>" />
                                    <p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rupiah" class="form-control" placeholder="Harga Buku"
                                        name="book_price" required value="<?= rupiah($book_detail['book_price']) ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="helperText" class="form-control" placeholder="Stok Buku"
                                        name="book_stock" min="0" value="<?= $book_detail['book_stock'] ?>" required />
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Penulis Buku"
                                        name="book_writer" value="<?= $book_detail['book_writer'] ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Penerbit Buku"
                                        name="book_publisher" value="<?= $book_detail['book_publisher'] ?>" />

                                </div>

                                <div class="form-group">
                                    <label for="helperText">Edisi Buku</label>
                                    <input type="text" class="form-control" placeholder="Edisi Buku" name="book_edition"
                                        value="<?= $book_detail['book_edition'] ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ukuran Buku" name="book_size"
                                        value="<?= $book_detail['book_size'] ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tebal Buku" name="book_thick"
                                        value="<?= $book_detail['book_thick'] ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Berat Buku"
                                        name="book_weight" value="<?= $book_detail['book_weight'] ?>" />
